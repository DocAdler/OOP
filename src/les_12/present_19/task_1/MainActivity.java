...
Записувати вік та ім’я з файлу в об’єкт типу Person.
Створений об’єкт записати у файл( toString() ).

 */

package les_12.present_19.task_1;
...
public class MainActivity {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
       ...
       BytesToFile.showPersonBytes();
        ...
        // Сериализация объекта (Externalizable);
